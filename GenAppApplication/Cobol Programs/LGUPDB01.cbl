      ...
      *    Move numeric commarea fields to DB2 Integer formats
		   ...
		   IF CA-M-ACCIDENTS <= 2
				COMPUTE CA-M-PREMIUM = CA-M-PREMIUM * 1.
		   IF CA-M-ACCIDENTS > 2 AND <= 5
				COMPUTE CA-M-PREMIUM = CA-M-PREMIUM * 1.20.
		   IF CA-M-ACCIDENTS > 5 AND <= 8
				COMPUTE CA-M-PREMIUM = CA-M-PREMIUM * 1.50.
		   IF CA-M-ACCIDENTS > 8 
				COMPUTE CA-M-PREMIUM = CA-M-PREMIUM * 2.
